...
// utiliza o 'queryBy' ao invés do 'getBy', pois o getBy retorna um erro
...
// Utiliza a função 'toHaveAttribute' verificamos se o elemento possui a classe com o nome esperado para cada situação.