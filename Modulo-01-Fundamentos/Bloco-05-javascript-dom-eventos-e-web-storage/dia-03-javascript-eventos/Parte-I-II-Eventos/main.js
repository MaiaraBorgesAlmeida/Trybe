...
// 3. Crie uma função que, ao clicar duas vezes em 'Meu top 3 do Spotrybefy', e redirecione para alguma página;
myWebpage.addEventListener('dblclick', function() {
  window.location.replace('https://maiaraborgesalmeida.github.io/');
});
